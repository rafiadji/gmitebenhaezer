...
@section('title_head')
    Tambah Jadwal Pembaptisan
@endsection

@section('bread')
    <li class="breadcrumb-item"><a href="{{ url('/home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('baptis.index') }}">Pembaptisan</a></li>
    <li class="breadcrumb-item active">Tambah Jadwal Pembaptisan</li>
@endsection

@section('content')
<form action="{{ route('baptis.store') }}" class="form-horizontal" method="POST">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="name_saksi_1" name="name_saksi_1" placeholder="Nama Saksi 1">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="name_saksi_2" class="col-sm-3 col-form-label">Nama Saksi 2</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="name_saksi_2" name="name_saksi_2" placeholder="Nama Saksi 2">
                        </div>
                    </div>
                </div>
