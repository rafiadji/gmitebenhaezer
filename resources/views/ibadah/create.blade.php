...
@section('bread')
    ...
    <li class="breadcrumb-item active">Tambah Jadwal Ibadah</li>
@endsection

@section('content')
<form action="{{ route('ibadah.store') }}" class="form-horizontal" method="POST">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Jadwal Ibadah</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                ...
                                <input type="text" id="tgl_ibadah" name="tgl_ibadah" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                ...
                                <input type="text" id="waktu_ibadah" name="waktu_ibadah" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="HH:MM" data-mask>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="tempat_ibadah" name="tempat_ibadah" placeholder="Tempat Ibadah">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pelayan" class="col-sm-3 col-form-label">Pelayan</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="pelayan" name="pelayan" placeholder="Pelayan">
                        </div>
                    </div>
                </div>
