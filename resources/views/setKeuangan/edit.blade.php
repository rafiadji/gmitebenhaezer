...
@section('bread')
    ...
    <li class="breadcrumb-item active">Ubah Setting Keuangan</li>
@endsection

@section('content')
<form action="{{ route('setKeuangan.update', $setKeuangan->id) }}" class="form-horizontal" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="icheck-primary d-inline">
                                <input type="radio" name="jenis_keuangan" value="pengeluaran" id="pengeluaran" @if ($setKeuangan->jenis_keuangan == 'pengeluaran') checked @endif>
